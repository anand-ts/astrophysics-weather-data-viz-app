    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300 flex flex-col">
      ...
      <div className="container mx-auto px-4 py-16 flex-1">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8">
          ...
          <Link to="/variables" className="w-full md:w-2/5">
            <div className="bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105 p-12">
          ...
          <Link to="/telescopes" className="w-full md:w-2/5">
            <div className="bg-purple-500 hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700 text-white rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105 p-12">
